...
function Header({
    ...
    return (<header className={`header ${isSidebarOpen ? '' : 'collapsed'}`} role="banner">
        <div className="header-top">
            ...
            >
                {theme === 'dark' ? (<svg className="header-icon" width="20" height="20" viewBox="0 0 24 24" fill="none"
                ...
                </svg>) : (<svg className="header-icon" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                strokeLinejoin="round"
                                aria-hidden>
        ...
        <div className="header-actions">
            ...
            >
                ...
                <span className="header-btn-icon" aria-hidden>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7"
                                                                                                height="7"/><rect x="14"
                                                                                                                  y="3"
                                                                                                                  width="7"
                                                                                                                  height="7"/><rect
                            x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
                    </span>
            </button>
            <button
            ...
            >
                ...
                <span className="header-btn-icon" aria-hidden>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon
                            points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/><line x1="8" y1="2" x2="8" y2="18"/><line
                            x1="16" y1="6" x2="16" y2="22"/></svg>
                    </span>
            </button>
            <button
            ...
            >
                ...
                <span className="header-btn-icon" aria-hidden>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 4v6h-6"/><path
                            d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>
                    </span>
            </button>
        </div>
        <div className="header-brand">
            <a href="#" className="header-logo" aria-label="GaelFórsa Home" onClick={(e) => {
                e.preventDefault();
                onMapClick();
            }}>
